  ...
  methods: {
    async getCovidVaccine() {
      ...
      try {
        ...
        const res = await this.$axios.$get(
          "https://covid-19-project.onrender.com/vaccine/api/covidVaccine"
        )
        //  const res = await this.$axios.$get("http://localhost:3000/api/covidVaccine")  // 本地端
        // "https://covid-19-project.onrender.com/vaccine/api/covidVaccine" // deploy
    ...
    async getCovidVaccineAll() {
      ...
      try {
        ...
        // "https://covid-19-project.onrender.com/vaccine/api/covidVaccineAll" // deploy
        const res = await this.$axios.$get(
          "https://covid-19-project.onrender.com/vaccine/api/covidVaccineAll"
        )
