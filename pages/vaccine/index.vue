  ...
  methods: {
    async getCovidVaccine() {
      ...
      try {
        ...
        const res = await this.$axios.$get(
          "https://because-hung.github.io/api/covidVaccine"
        )
        //  const res = await this.$axios.$get("http://localhost:3000/api/covidVaccine")  // 本地端
        // "https://because-hung.github.io/api/covidVaccine" // deploy
    ...
    async getCovidVaccineAll() {
      ...
      try {
        ...
        // "https://because-hung.github.io/api/covidVaccineAll" // deploy
        const res = await this.$axios.$get(
          "https://because-hung.github.io/api/covidVaccineAll"
        )
