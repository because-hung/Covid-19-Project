  ...
  <div class="content bg-gray-100 pb-16">
    ...
    <div class="GobalCardGroup grid grid-rows-1 grid-cols-4 gap-x-20 p-8">
      <div class="card border-2 bg-white p-8 font-bold">
        ...
        <h4 class="text-xl border-t-2 border-blue-500 mt-4 pt-2 text-right">
          全球今日確診人數
        </h4>
      </div>
      <div class="card border-2 bg-white p-8 font-bold">
      ...
      <div class="card border-2 bg-white p-8 font-bold">
        <h2 class="text-2xl">{{ this.gobalData.cases }}</h2>
        <h4 class="text-xl border-t-2 border-blue-500 mt-4 pt-2 text-right">
          全球累積確診案例
        </h4>
      </div>
      <div class="card border-2 bg-white p-8 font-bold">
        <h2 class="text-2xl">{{ this.gobalData.deaths }}</h2>
        <h4 class="text-xl border-t-2 border-blue-500 mt-4 pt-2 text-right">
          全球累積死亡案例
        </h4>
      </div>
    ...
    <div class="TaiwanCardGroup grid grid-rows-1 grid-cols-4 gap-x-20 p-8">
      <div class="card border-2 bg-white p-8 font-bold">
        <h2 class="text-2xl">
        ...
        <h4 class="text-xl pt-2 text-right">(若為 0 表示還沒更新)</h4>
      </div>
      <div class="card border-2 bg-white p-8 font-bold">
        <h2 class="text-2xl">
      ...
      <div class="card border-2 bg-white p-8 font-bold">
        <h2 class="text-2xl">{{ this.twData.cases }}</h2>
        <h4 class="text-xl border-t-2 border-blue-500 mt-4 pt-2 text-right">
          臺灣累積確診案例
        </h4>
      </div>
      <div class="card border-2 bg-white p-8 font-bold">
        <h2 class="text-2xl">{{ this.twData.deaths }}</h2>
        <h4 class="text-xl border-t-2 border-blue-500 mt-4 pt-2 text-right">
          臺灣累積死亡案例
        </h4>
      </div>
